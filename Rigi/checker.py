...
def ASSN_DIS(g1,c1,f1,g2,c2,f2,A,GS,GA):
    ...
    return ForAll(argv_list(argvA)+argv_list(argvB)+state_list(state), 
        Implies(And(state_axiom(state),state_axiom(state_),A(argvA,argvB),g1(new_state(state_),argvA),c1(new_state(state),argvA)),#  ,g1(state,argvA),I(state),I(f1(state,argvA))),
...
def proc_check(queue, cls, op1_index, op2_index, sop1_index, sop2_index):
    ...
    x1 = ASSN_COMMUTE(g1,c1,f1,g2,c2,f2,app.axiom,app.state,app.argv)
    success1 = judge(x1) 
